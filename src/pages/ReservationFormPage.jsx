...
export function ReservationFormPage() {
  ...
  return (
    <div className="page" style={{ maxWidth: "720px", width: "100%" }}>
      <div style={s.header}>
        <div>
        ...
        <div className="card" style={s.section}>
          <div style={s.attendeeHeaderMain}>
            <div style={s.sectionTitle}>
              Who's Coming{" "}
              <span className="muted" style={s.partyCount}>
            ...
            {attendees.map((a, idx) => (
              <div key={idx} style={s.attendeeCard}>
                ...
                <div style={{ marginTop: "12px" }}>
                  <div style={s.dietLabel}>Dietary</div>
                  <div style={s.dietGrid}>
                    {DIETARY_OPTIONS.map((opt) => (
                      <button
                        ...
                        style={{
                          ...s.dietBtn,
                          background: a.dietary_restrictions.includes(opt)
                            ? "var(--accent)"
                            : "white",
                          color: a.dietary_restrictions.includes(opt)
                            ? "white"
                            : "var(--text)",
                        }}
                      >
        ...
        <div style={s.submitRow}>
          ...
          <div style={s.submitActions}>
            ...
            <button
              ...
              style={s.submitBtn}
            >
              {loading ? "..." : confirmNow ? "Confirm" : "Save Draft"}
            </button>
          </div>
        </div>
      </form>
...
const s = {
  ...
  partyCount: { fontSize: "13px", fontFamily: "inherit", fontWeight: 400 },
  emptyState: {
    padding: "20px",
    textAlign: "center",
    color: "var(--muted)",
  ...
  guestInput: { flex: "1 1 200px", maxWidth: "100%" },
  submitRow: {
    display: "flex",
    justifyContent: "space-between",
    alignItems: "center",
