...
function getTimeSlots(mealType, dateStr) {
  ...
  const dinnerDays = [4, 5, 6]; // Thu, Fri, Sat
...
export function ReservationForm() {
  ...
  // Pull max party size from schema config, fallback to 4
  ...
  // Each attendee: { member_id, guest_name, dietary_restrictions, isBooker, _source_dietary }
  // _source_dietary = original dietary from member record (for revert logic)
  ...
  // Add a saved member — pre-populate their dietary restrictions from their record
  ...
  // Toggle dietary for this session only — does NOT save back to member record
  ...
  // Revert one attendee's dietary back to their member record
                  ...
                  >
                    {isDirtyDietary(a) && (
                      <button
                        ...
                        style={{ ...s.revertBtn }}
                        title="Revert dietary to saved preferences"
                      >
                        ↺ Revert
                      </button>
                    )}
                ...
                <div style={{ marginTop: "12px" }}>
                  ...
                  <div style={s.dietGrid}>
                    {DIETARY_OPTIONS.map((opt) => {
                      ...
                      // Show visually if this is being toggled off from a saved preference
